...
class GnuChanOSSetOrigin(bpy.types.Panel):
    bl_label = "Set Origin for Ursina"
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.operator("object.origin_set", text="Set Origin to 3D Cursor").type = 'ORIGIN_CURSOR'
        
        row = layout.row()
        row.operator("object.origin_set", text="Set Origin to Geometry").type = 'ORIGIN_GEOMETRY'
